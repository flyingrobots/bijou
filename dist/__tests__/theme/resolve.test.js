...
import { getTheme, resolveTheme, isNoColor, _resetThemeForTesting, createThemeResolver, } from '../../theme/resolve.js';
describe('resolve', () => {
    beforeEach(() => {
...
describe('createThemeResolver', () => {
    ...
    it('uses custom fallback', async () => {
        const { TEAL_ORANGE_PINK } = await import('../../theme/presets.js');
