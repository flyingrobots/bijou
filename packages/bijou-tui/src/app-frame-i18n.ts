...
export const FRAME_I18N_CATALOG: I18nCatalog = {
  ...
  entries: [
    ...
    message('notifications.summary.liveArchived', 'Live: {liveCount} • Archived: {archivedCount}'),
    ...
    message('notifications.history.empty', 'No archived notifications for {filter} yet.'),
