...
- **Respecting the Dojo burndown** — WF-135 lowers live type-aware ESLint
  findings from `4,517` to `1,928`, cutting `2,598` counted Code Dojo
  ...
  safe-indexing cleanup. The aggregate debt ceiling now ratchets from `4,940`
  to `2,342`, with the next goalpost target set to `2,292` or lower, while touched
