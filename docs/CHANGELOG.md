...
- **Respecting the Dojo burndown** — WF-135 lowers live type-aware ESLint
  findings from `4,517` to `2,929`, cutting `1,595` counted Code Dojo
  ...
  render differ packed-byte and legacy cell-path cleanup. The aggregate debt
  ceiling now ratchets from `4,940` to `3,345`, with the next goalpost target
  set to `3,295` or lower, while touched file/context budgets
