...
- **Respecting the Dojo burndown** — WF-135 lowers live type-aware ESLint
  findings from `4,517` to `3,237`, cutting `1,287` counted Code Dojo
  ...
  file/context cleanups. The aggregate debt ceiling now ratchets from `4,940`
  to `3,653`, with the next goalpost target set to `3,603` or lower, while
  touched file/context budgets remain held under their stored ceilings.
