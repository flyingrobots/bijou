...
- **Respecting the Dojo burndown** — WF-135 lowers live type-aware ESLint
  findings from `4,517` to `2,528`, cutting `1,996` counted Code Dojo
  ...
  pipeline rejection cleanup. The aggregate debt ceiling now ratchets from
  `4,940` to `2,944`, with the next goalpost target set to `2,894` or lower,
  while touched
