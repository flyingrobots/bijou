...
- **Respecting the Dojo burndown** — WF-135 lowers live type-aware ESLint
  findings from `4,517` to `3,316`, cutting `1,208` counted Code Dojo
  violations across the initial 1000-count pass and follow-on fake-async,
  dead-fixture, explicit-formatting, script/example, and file/context cleanups.
  The aggregate debt ceiling now ratchets from `4,940` to `3,732`, with the next
  goalpost target set to `3,682` or lower, while touched file/context budgets
  remain held under their stored ceilings.
