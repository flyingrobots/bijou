...
- **Respecting the Dojo burndown** — WF-135/WF-142 lower live type-aware ESLint
  findings from `4,517` to `1,182`, cutting `3,347` counted Code Dojo
  ...
  DAG source checked traversal, and image-viewer app/test surface typing, plus
  DOGFOOD docs story numeric-label formatting and block-registry contract
  cleanup. The aggregate debt ceiling now ratchets from `4,940` to `1,593`,
  with the next goalpost target set to `1,543` or lower, while touched
