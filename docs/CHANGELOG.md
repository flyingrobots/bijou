...
- **Respecting the Dojo burndown** — WF-135 lowers live type-aware ESLint
  findings from `4,517` to `3,128`, cutting `1,396` counted Code Dojo
  ...
  app-frame render fixture cleanups. The aggregate debt ceiling now ratchets
  from `4,940` to `3,544`, with the next goalpost target set to `3,494` or
  lower, while touched file/context budgets remain held under their stored
  ceilings.
