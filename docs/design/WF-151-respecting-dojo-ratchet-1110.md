# WF-151 Respecting the Dojo Ratchet To 1110
...
- GitHub Issue: [#407](https://github.com/flyingrobots/bijou/issues/407)
- Pull Request: [#408](https://github.com/flyingrobots/bijou/pull/408)
...
Live counts on `main` at `de8fe5bc`:
...
- `packages/bijou/src/core/components/markdown.ts`
- `packages/bijou/src/core/components/markdown.test.ts`
- `packages/bijou/src/core/components/table.ts`
- `packages/bijou/src/core/components/table.test.ts`
...
1. Is aggregate Code Dojo debt at `1,110` or lower?
