...
| ESLint baseline | 1,101 | Type-aware ESLint findings after the WF-144 ratchet pass. |
| **Total** | **1,511** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `1,511`. The next met goalpost must lower the ceiling to
`1,461` or lower.
