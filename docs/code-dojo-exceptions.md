...
| :--- | ---: | :--- |
| File/context baseline | 334 | Files over the Code Dojo context threshold. |
...
| ESLint baseline | 1,877 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **2,290** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `2,290`. The next met goalpost must lower the ceiling to
`2,240` or lower.
