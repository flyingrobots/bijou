...
| ESLint baseline | 3,493 | Type-aware ESLint findings after the WF-135 1000-count burndown. |
| **Total** | **3,916** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,916`. The next met goalpost must lower the ceiling to
`3,866` or lower.
