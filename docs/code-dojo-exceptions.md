...
| ESLint baseline | 1,716 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **2,128** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `2,128`. The next met goalpost must lower the ceiling to
`2,078` or lower.
