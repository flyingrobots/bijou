...
| ESLint baseline | 2,981 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,397** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,397`. The next met goalpost must lower the ceiling to
`3,347` or lower.
