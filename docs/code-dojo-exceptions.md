...
| ESLint baseline | 1,985 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **2,399** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `2,399`. The next met goalpost must lower the ceiling to
`2,349` or lower.
