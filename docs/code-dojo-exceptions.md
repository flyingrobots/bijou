...
| ESLint baseline | 909 | Type-aware ESLint findings after the WF-147 ratchet pass. |
| **Total** | **1,318** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `1,318`. The next met goalpost must lower the ceiling to
`1,268` or lower.
