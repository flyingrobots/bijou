...
| ESLint baseline | 2,580 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **2,996** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `2,996`. The next met goalpost must lower the ceiling to
`2,946` or lower.
