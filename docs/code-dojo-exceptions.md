...
| ESLint baseline | 3,128 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,544** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,544`. The next met goalpost must lower the ceiling to
`3,494` or lower.
