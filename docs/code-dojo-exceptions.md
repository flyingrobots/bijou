...
| ESLint baseline | 3,053 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,469** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,469`. The next met goalpost must lower the ceiling to
`3,419` or lower.
