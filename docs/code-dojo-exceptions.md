...
| ESLint baseline | 1,038 | Type-aware ESLint findings after the WF-145 ratchet pass. |
| **Total** | **1,447** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `1,447`. The next met goalpost must lower the ceiling to
`1,397` or lower.
