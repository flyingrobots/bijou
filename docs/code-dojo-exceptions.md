...
| ESLint baseline | 545 | Type-aware ESLint findings after the WF-154 ratchet pass. |
| **Total** | **953** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `953`. The next met goalpost must lower the ceiling to
`903` or lower.
