...
| ESLint baseline | 2,092 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **2,506** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `2,506`. The next met goalpost must lower the ceiling to
`2,456` or lower.
