...
| ESLint baseline | 3,376 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,799** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,799`. The next met goalpost must lower the ceiling to
`3,749` or lower.
