...
| ESLint baseline | 2,721 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,137** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,137`. The next met goalpost must lower the ceiling to
`3,087` or lower.
