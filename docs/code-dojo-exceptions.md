...
| ESLint baseline | 543 | Type-aware ESLint findings after the WF-154 ratchet pass. |
| **Total** | **951** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `951`. The next met goalpost must lower the ceiling to
`901` or lower.
