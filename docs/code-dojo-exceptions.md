...
| ESLint baseline | 2,658 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,074** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,074`. The next met goalpost must lower the ceiling to
`3,024` or lower.
