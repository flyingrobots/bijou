...
| ESLint baseline | 1,154 | Type-aware ESLint findings after the WF-143 ratchet pass. |
| **Total** | **1,564** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `1,564`. The next met goalpost must lower the ceiling to
`1,514` or lower.
