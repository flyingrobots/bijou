...
| ESLint baseline | 1,182 | Type-aware ESLint findings after the WF-142 ratchet pass. |
| **Total** | **1,593** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `1,593`. The next met goalpost must lower the ceiling to
`1,543` or lower.
