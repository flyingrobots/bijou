...
| ESLint baseline | 1,206 | Type-aware ESLint findings after the WF-142 ratchet pass. |
| **Total** | **1,617** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `1,617`. The next met goalpost must lower the ceiling to
`1,567` or lower.
