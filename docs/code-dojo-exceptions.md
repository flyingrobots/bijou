...
| ESLint baseline | 2,838 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,254** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,254`. The next met goalpost must lower the ceiling to
`3,204` or lower.
