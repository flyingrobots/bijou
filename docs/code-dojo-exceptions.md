...
| ESLint baseline | 2,929 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,345** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,345`. The next met goalpost must lower the ceiling to
`3,295` or lower.
