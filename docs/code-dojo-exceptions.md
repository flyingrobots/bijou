...
| ESLint baseline | 1,928 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **2,342** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `2,342`. The next met goalpost must lower the ceiling to
`2,292` or lower.
