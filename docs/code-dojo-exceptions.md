...
| ESLint baseline | 2,528 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **2,944** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `2,944`. The next met goalpost must lower the ceiling to
`2,894` or lower.
