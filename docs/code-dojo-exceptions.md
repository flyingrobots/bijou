...
| ESLint baseline | 2,771 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,187** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,187`. The next met goalpost must lower the ceiling to
`3,137` or lower.
