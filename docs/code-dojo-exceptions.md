...
| ESLint baseline | 3,298 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **3,714** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `3,714`. The next met goalpost must lower the ceiling to
`3,664` or lower.
