...
| ESLint baseline | 2,036 | Type-aware ESLint findings after the WF-135 burndown passes. |
| **Total** | **2,450** | Aggregate Code Dojo standards debt. |
...
The current ceiling is `2,450`. The next met goalpost must lower the ceiling to
`2,400` or lower.
