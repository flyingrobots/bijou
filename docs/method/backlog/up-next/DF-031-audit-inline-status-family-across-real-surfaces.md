---
title: DF-031 Audit inline status family across real surfaces
legend: DF
lane: up-next
priority: medium
keywords:
...
# DF-031 Audit inline status family across real surfaces

Audit the inline status family against real runtime behavior instead of trusting fixtures or docs alone.
