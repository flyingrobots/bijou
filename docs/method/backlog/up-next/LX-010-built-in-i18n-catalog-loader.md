...
The current i18n runtime still requires callers to manually orchestrate catalog
loading. `docs/BEARING.md` and `docs/ROADMAP.md` both continue to call out a
built-in catalog loader as active repo gravity, so this legacy note needs a
canonical METHOD home again.
