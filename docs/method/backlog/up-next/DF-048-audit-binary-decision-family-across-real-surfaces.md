---
title: DF-048 Audit binary decision family across real surfaces
legend: DF
lane: up-next
priority: medium
keywords:
...
# DF-048 Audit binary decision family across real surfaces

Audit the binary decision family against real runtime behavior instead of trusting fixtures or docs alone.
