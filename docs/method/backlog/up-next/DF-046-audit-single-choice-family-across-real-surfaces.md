---
title: DF-046 Audit single choice family across real surfaces
legend: DF
lane: up-next
priority: medium
keywords:
...
# DF-046 Audit single choice family across real surfaces

Audit the single choice family against real runtime behavior instead of trusting fixtures or docs alone.
