...
Superseded by [DX-021 — Error Surface for Crash Post-Mortems](../retro/DX-021-error-surface-post-mortem.md).
The crash-surface work shipped, but this older backlog note used the
`DX-016` identifier before that id was later reused for scenario-provenance
bench work. Keep this file only as historical lineage for the legacy backlog
tree.
