...
| **Design-System Documentation Completeness** | docs | The design-system docs now define graceful lowering as a required field, but many component-family entries still do not document rich/static/pipe/accessible behavior explicitly. Finish the docs so every mature family page actually satisfies the stated documentation standard. |
