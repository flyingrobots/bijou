...
| `v8.2.0` | [v8.2.0](https://github.com/flyingrobots/bijou/milestone/8) | 17 | 1 | Quality automation, Method hardening, and Code Dojo visibility horizon. |
...
The first Code Dojo prerequisite
[#469](https://github.com/flyingrobots/bijou/issues/469) has met its `112`
aggregate-debt contract. [#477](https://github.com/flyingrobots/bijou/issues/477)
now owns the next `112 -> 62` goalpost. Its landed tranche A
...
- **Immediate prerequisite**:
  [#477](https://github.com/flyingrobots/bijou/issues/477) must land the `62`
  aggregate Code Dojo goalpost before the bounded Profunctor Page inspection
  story [#468](https://github.com/flyingrobots/bijou/issues/468) can close.
