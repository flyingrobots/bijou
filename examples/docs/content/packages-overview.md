...
- `@flyingrobots/bijou` — core surfaces, tokens, layout helpers, and components
- `@flyingrobots/bijou-node` — Node adapters for runtime and styling
- `@flyingrobots/bijou-tui` — framed shell and terminal app runtime
- `@flyingrobots/bijou-tui-app` — app helpers and shell scaffolding
