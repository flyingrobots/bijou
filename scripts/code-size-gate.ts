...
export const CODE_SIZE_BASELINE: readonly CodeSizeBaselineEntry[] = Object.freeze([
  ...
  { path: 'packages/bijou-tui/src/app-frame-actions.ts', lines: 569 },
  { path: 'packages/bijou-tui/src/transition-shaders.test.ts', lines: 564 },
  { path: 'scripts/smoke-all-examples-lib.ts', lines: 562 },
