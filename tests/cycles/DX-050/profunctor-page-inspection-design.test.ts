...
describe('DX-050 Profunctor Page inspection design', () => {
  ...
  it('keeps roadmap and bearing aligned with live tracker truth', () => {
    ...
    expectClaims(bearing, [
      '`v8.2.0` milestone is quality automation and reliability: 23 open and 8 closed milestone items',
      '`v8.0.0` milestone is complete Runtime Graph release-closeout lineage: 0 open milestone items and 7 closed milestone items',
      '[DX-050](./design/DX-050-profunctor-page-inspection.md)',
