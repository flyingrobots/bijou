...
describe('WF-130 roadmap supporting contracts', () => {
  it('aligns bearing, release, design, and tracker lineage', () => {
    ...
    expectClaims(bearing, [
      ...
      'Tranche D is selected to lower those ledgers to `17` and `5`.',
      ...
      'Tranche D now owns `Surface`, DOGFOOD i18n-debt analysis, framed-app overlays, `ui-scene-ir/1`, and the terminal differ, targeting an aggregate ceiling of `22`.',
