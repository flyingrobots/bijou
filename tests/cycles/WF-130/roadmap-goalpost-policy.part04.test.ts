...
describe('WF-130 roadmap supporting contracts', () => {
  it('aligns bearing, release, design, and tracker lineage', () => {
    ...
    expectClaims(bearing, [
      ...
      'Landed tranche A [#475](https://github.com/flyingrobots/bijou/pull/475) and WF-164 tranche B each removed `25` counted violations.',
      'Current debt comprises `37` file/context and `25` code-size violations with no mock-ban or ESLint debt.',
      'The next bounded target is [#468](https://github.com/flyingrobots/bijou/issues/468)',
      ...
      '`v8.2.0` milestone is quality automation and Method hardening: 16 open and 2 closed milestone items',
      'No open issue is currently unmilestoned',
