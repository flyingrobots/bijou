...
describe('WF-130 roadmap supporting contracts', () => {
  it('aligns bearing, release, design, and tracker lineage', () => {
    ...
    expectClaims(bearing, [
      ...
      'Tranche C selects the canonical example app, Notifications, Image Viewer, the PR review-status tool, and framed-app rendering as the next five smallest roots.',
      'It targets `32` aggregate violations and `10` remaining double-counted roots.',
