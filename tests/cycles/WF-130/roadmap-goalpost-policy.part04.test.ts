...
describe('WF-130 roadmap supporting contracts', () => {
  it('aligns bearing, release, design, and tracker lineage', () => {
    ...
    expectClaims(bearing, [
      ...
      'Tranche D [#488](https://github.com/flyingrobots/bijou/pull/488) preserves five more public entrypoints as focused families and lowers those ledgers to `17` and `5`.',
      ...
      'Tranche D [#488](https://github.com/flyingrobots/bijou/pull/488) preserves `Surface`, DOGFOOD i18n-debt analysis, framed-app overlays, `ui-scene-ir/1`, and the terminal differ behind stable facades, lowering the live ceiling to `22`; five double-counted roots remain.',
      ...
      '`v8.2.0` milestone is quality automation and Method hardening: 22 open and 2 closed milestone items',
