...
describe('WF-130 roadmap supporting contracts', () => {
  it('aligns bearing, release, design, and tracker lineage', () => {
    ...
    expectClaims(bearing, [
      ...
      '[#477](https://github.com/flyingrobots/bijou/issues/477) owns the next `112 -> 62` goalpost.',
      'Its landed tranche A [#475](https://github.com/flyingrobots/bijou/pull/475) reduced measured debt to `87`, comprising `61` file/context and `26` code-size violations with no mock-ban or ESLint debt.',
      'Tranche B is the immediate target and must lower the encoded ceiling to `62` or lower.',
      'The following bounded target is [#468](https://github.com/flyingrobots/bijou/issues/468)',
      ...
      '`v8.2.0` milestone is quality automation and Method hardening: 17 open and 1 closed milestone item',
      'No open issue is currently unmilestoned',
