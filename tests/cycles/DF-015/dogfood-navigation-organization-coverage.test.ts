...
describe('DF-015 DOGFOOD navigation and organization coverage cycle', () => {
  it('creates an active cycle doc with the required workflow sections', () => {
    const cycle = read('/Users/james/git/bijou/docs/design/DF-015-raise-dogfood-coverage-floor-to-69-percent.md');
  ...
  it('spawns the next DOGFOOD cycle', () => {
    expect(
      existsSync('/Users/james/git/bijou/docs/BACKLOG/DF-016-raise-dogfood-coverage-floor-to-74-percent.md') ||
      existsSync('/Users/james/git/bijou/docs/design/DF-016-raise-dogfood-coverage-floor-to-74-percent.md'),
    ).toBe(true);
  });
});
