...
describe('DF-016 DOGFOOD data comparison and list coverage cycle', () => {
  it('creates an active cycle doc with the required workflow sections', () => {
    const cycle = read('/Users/james/git/bijou/docs/design/DF-016-raise-dogfood-coverage-floor-to-74-percent.md');
  ...
  it('spawns the next DOGFOOD cycle', () => {
    expect(
      existsSync('/Users/james/git/bijou/docs/BACKLOG/DF-017-raise-dogfood-coverage-floor-to-79-percent.md') ||
      existsSync('/Users/james/git/bijou/docs/design/DF-017-raise-dogfood-coverage-floor-to-79-percent.md'),
    ).toBe(true);
  });
});
