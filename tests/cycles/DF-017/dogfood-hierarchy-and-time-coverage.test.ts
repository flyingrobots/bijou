...
describe('DF-017 DOGFOOD hierarchy and time/dependency coverage cycle', () => {
  it('creates an active cycle doc with the required workflow sections', () => {
    const cycle = read('/Users/james/git/bijou/docs/design/DF-017-raise-dogfood-coverage-floor-to-79-percent.md');
  ...
  it('spawns the next DOGFOOD cycle', () => {
    expect(
      existsSync('/Users/james/git/bijou/docs/BACKLOG/DF-018-raise-dogfood-coverage-floor-to-84-percent.md') ||
      existsSync('/Users/james/git/bijou/docs/design/DF-018-raise-dogfood-coverage-floor-to-84-percent.md'),
    ).toBe(true);
  });
});
