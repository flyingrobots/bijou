...
import { DOGFOOD_BLOCK_PACKAGE, dogfoodBlockRegistry, dogfoodBlockRegistryEntry, isDogfoodBlockRegistry, isDogfoodBlockRegistryEntry } from '../../../examples/docs/dogfood-blocks.js';
